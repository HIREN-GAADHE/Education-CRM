...
Revision ID: f848fd52f4f8
Revises: 340d1f1a1822
Create Date: 2026-02-01 08:42:29.069198+00:00
...
revision: str = 'f848fd52f4f8'
down_revision: Union[str, None] = '340d1f1a1822'
...
def upgrade() -> None:
    ...
    op.add_column('attendance', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=sa.text('false')))
    op.add_column('attendance', sa.Column('deleted_at', sa.DateTime(), nullable=True))
    op.add_column('attendance', sa.Column('deleted_by', sa.UUID(), nullable=True))
